...
-- Module Name: sum_of_n - Behavioral
-- Project Name: assignment 5
-- Target Devices: pynq-z1
-- Tool Versions: Vivado 2020.1
-- Description:
-- 	simple top level design for a general computational engine
--  
-- Dependencies:
-- 	none
-- Revision:
-- Revision 0.5 - imperovement & consistency with documentation
-- Additional Comments:
--
----------------------------------------------------------------------------------
...
architecture Behavioral of sum_of_n is
...
begin
	...
	i_controller : entity work.controller(sum_of_n_behave)
		generic map (
			bit_width => bit_width
		)
		port map (
