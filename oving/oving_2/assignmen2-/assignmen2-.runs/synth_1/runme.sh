...
HD_PWD='C:/Users/susan/OneDrive/Dokumenter/studiene/DDS1/TFE4141_Digital_Design_1/oving/oving_2/assignmen2-/assignmen2-.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log logic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source logic.tcl
